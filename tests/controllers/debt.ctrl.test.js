describe('DebtController', function() {
  ...
  describe('/debt', function() {
    ...
    it('return debts + populated user', function (done) {
      var _debt
      var _user
      var _user2
      Promise.resolve()
        ...
        .then(function () {
          return request(sails.hooks.http.app)
            ...
            .expect(function(res) {
              ...
              assert(_.isObject(debts[0].user))
              assert(_.isEqual(debts[0].user.id, _user.id))
            })
        })
        ...
        .then(function () {
          return request(sails.hooks.http.app)
            ...
            .expect(function(res) {
              ...
              assert(_.isEqual(debts[0].id, _debt.id))
              assert(_.isObject(debts[0].user))
              assert(_.isEqual(debts[0].user.user_id, _debt.borrower_id))
            })
        })
        .then(function (res) { return Debt.destroy({id:_debt.id}) })
        .then(function () { return User.destroy({id:_user.id}) })
        ...
        .then(function () {
          return request(sails.hooks.http.app)
            ...
            .expect(function(res) {
              ...
              assert(_.isEqual(debts[0].id, _debt.id))
              assert(_.isObject(debts[0].user))
              assert(_.isEqual(debts[0].user.user_id, _debt.lender_id))
            })
        })
        .then(function (res) { return Debt.destroy({id:_debt.id}) })
        .then(function () { return User.destroy({id:_user.id}) })
